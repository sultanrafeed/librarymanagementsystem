    ...
    <div class="reg_img">
        ...
        <div class="box2">
            ...
            <div class="login"> 
              ...
              <input class="form-control" type="text" name="studentID" placeholder="Roll No" required=""><br>
         ...
         if(isset($_POST['submit']))
         {
            ...
            $sql="Select username from `student`"; /*selecting the username queury to mkae it unique*/
            ...
            if($count==0)
            {
              mysqli_query($db,"INSERT INTO `student` VALUES('', '$_POST[firstname]', '$_POST[lastname]',  '$_POST[username]',  '$_POST[password]', '$_POST[studentID]', '$_POST[email]',  '$_POST[contact]','student.jpg' );");
         ?>

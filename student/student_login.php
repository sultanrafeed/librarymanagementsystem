     ...
     if(isset($_POST['submit']))
      {
        ...
        $res=mysqli_query($db,"SELECT * FROM `student` WHERE username='$_POST[username]' && password='$_POST[password]';"); /*this will select a row but now we will count how many rows have matched*/

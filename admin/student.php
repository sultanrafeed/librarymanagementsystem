...
<div class="h" >="request.php">Book Request</a></div>
<div class="h" >="issue_info.php">Issue Information</a></div>
...
{
    $q=mysqli_query($db, "SELECT firstname,lastname,username,studentID,email,contact FROM `student` where username like '%$_POST[search]%' ");
    ...
    {
            $res=mysqli_query($db,"SELECT firstname,lastname,username,studentID,email,contact FROM `student`; ");
